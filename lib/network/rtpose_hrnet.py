...
def get_model(cfg, is_train, **kwargs):
    ...
    # Stage 1
    blocks['block1_1'] = [{'conv5_1_CPM_L1': [32, 128, 3, 1, 1]},
                          {'conv5_2_CPM_L1': [128, 128, 3, 1, 1]},
                          {'conv5_3_CPM_L1': [128, 128, 3, 1, 1]},
                          {'conv5_4_CPM_L1': [128, 512, 1, 1, 0]},
                          {'conv5_5_CPM_L1': [512, 38, 1, 1, 0]}]

    blocks['block1_2'] = [{'conv5_1_CPM_L2': [32, 128, 3, 1, 1]},
    ...
    for i in range(2, 3):
        blocks['block%d_1' % i] = [
            {'Mconv1_stage%d_L1' % i: [89, 128, 7, 1, 3]},
        ...
        blocks['block%d_2' % i] = [
            {'Mconv1_stage%d_L2' % i: [89, 128, 7, 1, 3]},
    ...
    # models['block0'] = get_pose_net(cfg, is_train)
    ...
    class rtpose_model(nn.Module):
        def __init__(self, model_dict):
            ...
            self.model0 = get_pose_net(cfg, is_train)
